...
public interface ImageProcessingService {
    // Glavna metoda sada piše direktno u OutputStream klijenta/servisa
    void processImage(InputStream inputStream, OutputStream outputStream, Integer maxWidth, Integer maxHeight, String outputFormat, boolean applySepia, boolean applyBlur) throws IOException;

    // Pomoćne metode ostaju slične, ali internalizirane
    ...
    String getOriginalImageFormat(InputStream is) throws IOException;
}//package hr.algebra.nrako.photoapp_backend.service;
//
//import java.awt.image.BufferedImage;
