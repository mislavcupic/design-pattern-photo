...
public class StorageServiceImpl implements StorageService {
    ...
    public StorageServiceImpl(Storage googleCloudStorage, Bucket storageBucket) {
        ...
        logger.info("StorageServiceImpl: Bucket {} injektiran.", storageBucket.getName());
    }

    @PreDestroy
    public void destroy() {
        logger.info("StorageServiceImpl: PreDestroy called.");
    }

    @Override
    public String uploadPhoto(MultipartFile file, String filename) {
        try {
            return uploadPhotoFromStream(file.getInputStream(), filename, file.getContentType());
        } catch (IOException e) {
    ...
    @Override
    public String uploadPhotoFromStream(InputStream content, String filename, String contentType) {
        try {
            ...
            logger.info("File uploaded successfully via stream: {}", filename);
            return filename;
        } catch (Exception e) {
    ...
    public void deletePhoto(String filename) {
        googleCloudStorage.delete(BlobId.of(storageBucket.getName(), filename));
    }

    @Override
    public InputStream downloadPhotoAsStream(String filename) {
        Blob blob = googleCloudStorage.get(BlobId.of(storageBucket.getName(), filename));
